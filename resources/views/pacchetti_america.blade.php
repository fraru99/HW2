<html>
    <head>
        ...
        <link rel="stylesheet" href="{{url("css/pacchetti_america.css")}}">
        <script src="{{url("js/pacchetti_america.js")}}" defer></script>
        <title>America</title>
    </head>
    <body>
        <header>
            ...
            <h1>
                <em>SUD AMERICA</em><br>
                <p>-I migliori viaggi dedicati al continente americano-</p>
                <p>Cerca</p>
