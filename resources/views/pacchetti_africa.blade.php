<html>
    <head>
        ...
        <link rel="stylesheet" href="{{url("css/pacchetti_africa.css")}}">
        <script src="{{url("js/pacchetti_africa.js")}}" defer></script>
        <title>Africa</title>
    </head>
    <body>
        <header>
            ...
            <h1>
                <em>AFRICA</em><br>
                <p>-I migliori viaggi dedicati al continente africano-</p>
                <p>Cerca</p>
